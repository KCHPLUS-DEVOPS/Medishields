...
import { Compass, FileText, Layers, MessageCircle, Stethoscope } from "lucide-react";
      ...
      <section className="relative overflow-hidden bg-offwhite px-6 md:px-12 flex items-center py-28 md:py-36 min-h-[80vh]">
        ...
        >
          <motion.div variants={fadeUp} className="flex justify-center mb-6">
            <span className="flex h-16 w-16 items-center justify-center rounded-2xl bg-teal/10 text-teal shadow-[0_10px_30px_-15px_rgba(14,20,20,0.25)]">
          ...
          <motion.div variants={fadeUp}>
            <p
              className="font-display text-[6.5rem] md:text-[10rem] leading-none tracking-tight select-none bg-gradient-to-br from-teal via-teal-dark to-ink bg-clip-text text-transparent"
          ...
          <motion.div variants={fadeUp} className="-mt-4 md:-mt-6">
            <KickerLabel>You&rsquo;ve wandered off the map</KickerLabel>
          </motion.div>
