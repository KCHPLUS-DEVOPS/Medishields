...
const valueProps = [
  "Joint replacement and revision procedures coded with precision",
  "Spine fusion and instrumentation billed accurately, every level",
  "Prior authorization secured proactively for surgeries and implants",
  "Modifier application expertise for co-surgeries and distinct procedures",
  "High-value implant and device costs fully captured",
  "Bundled multi-procedure cases billed without revenue loss",
];
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap
        ...
        .from(".ortho-hero-crumb", { opacity: 0, y: 10, duration: 0.5 })
        .from(".ortho-hero-sub", { opacity: 0, y: 14, duration: 0.5 }, "-=0.3")
        .from(".ortho-hero-bullet", { opacity: 0, y: 10, duration: 0.4, stagger: 0.06 }, "-=0.2")
        .from(".ortho-hero-cta", { opacity: 0, y: 10, duration: 0.4, stagger: 0.08 }, "-=0.2")
        .from(".ortho-hero-icon", { opacity: 0, scale: 0.9, duration: 0.7 }, "-=0.6");
    }, sectionRef);
    return () => ctx.revert();
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-content mx-auto">
        <div
          aria-hidden
          className="ortho-hero-icon pointer-events-none absolute top-[4%] right-0 hidden xl:block w-[26vw] max-w-[380px] min-w-[260px] select-none"
        >
          <Image
            src="/icons/specialties/orthopedic.webp"
            alt=""
            width={907}
            height={1360}
        ...
        <nav aria-label="Breadcrumb" className="ortho-hero-crumb mb-6 flex items-center gap-1.5 text-sm text-ink/50">
          <Link href="/specialties" className="hover:text-teal transition-colors">
            Specialties
          </Link>
          <ChevronRight className="h-3.5 w-3.5" />
          <span className="text-ink/80 font-medium">Orthopedic</span>
        </nav>

        <h1 className="font-display text-4xl md:text-6xl tracking-tight leading-[1.05] text-ink max-w-2xl xl:max-w-xl">
          <SplitText
            tag="span"
            text={["Expert Orthopedic", "Billing Services"]}
        ...
        <p className="ortho-hero-sub mt-6 max-w-2xl text-lg text-ink/70 leading-relaxed">
          From operating room to optimal revenue: surgical revenue solved for joint
          replacements, spine surgery, sports medicine, and implants.
        </p>

        <ul className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl">
          {valueProps.map((item) => (
            <li key={item} className="ortho-hero-bullet flex items-start gap-2.5 text-sm text-ink/75">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-end">
          <div>
            <motion.div variants={fadeUp}>
              <KickerLabel>Cut through orthopedic billing complexity</KickerLabel>
            </motion.div>
            <motion.h2
              variants={fadeUp}
              className="font-display text-3xl md:text-4xl tracking-tight leading-[1.1] text-ink max-w-3xl"
            >
              Expert Solutions for Surgical Practices
            </motion.h2>
            <motion.div variants={fadeUp} className="mt-6 max-w-3xl space-y-4 text-ink/70 text-lg leading-relaxed">
              <p>
                Orthopedic billing is fraught with complex coding, prior authorization hurdles, and
                costly claim denials, including downcoding on multi-level fusions and fracture care
                bundles, modifier misapplication on co-surgeries and distinct procedures, and medical
                necessity denials on high-cost implants all chip away at revenue your surgeons have
                already earned.
              </p>
              <p>
                MediShields is your one-stop revenue cycle management partner, offering far more than
                basic billing. Our all-inclusive package tackles credentialing, prior authorization,
                denial management, and patient collections, eliminating revenue loss caused by
                billing challenges specific to orthopedic surgery.
              </p>
            </motion.div>
          </div>
          <motion.div variants={fadeUp}>
            <ParallaxImage
              src="/icons/specialties/overview/orthopedic.webp"
              alt="Orthopedic billing specialists"
            />
          </motion.div>
        </div>
      </Reveal>
...
const metrics: Metric[] = [
  { Icon: Clock, value: 28, prefix: "↓ ", suffix: " Days", label: "Days in Accounts Receivable", description: "Faster collection cycles on surgical claims" },
  { Icon: FileCheck, value: 96, suffix: "%", label: "First Claim Approval", description: "Clean coding on joint replacements and spine surgery" },
  { Icon: TrendingUp, value: 16, staticText: "12–16%", label: "Average Revenue Improvement", description: "More of what orthopedic practices earn" },
  { Icon: Gauge, value: 94, suffix: "%", label: "Collection Efficiency", description: "Maximized reimbursement across every payer" },
  { Icon: CheckCircle2, value: 98, suffix: "%", label: "Error-Free Claim Rate", description: "Fewer denials on complex multi-procedure cases" },
];
...
const segments: Segment[] = [
  {
    Icon: Bone,
    name: "Joint Replacements & Revisions",
    benefits: [
      "Precise coding for hips, knees, shoulders, and revisions",
      "Accurate billing across primary and revision arthroplasties",
      "High-value implant costs fully captured",
      "Reduced denials on complex joint procedures",
      "Consistent coding standards across every joint type",
      "Full revenue-cycle visibility on replacement procedures",
    ],
  },
  {
    Icon: Layers,
    name: "Spine Surgery & Fusions",
    benefits: [
      "Multi-level fusion procedures coded accurately",
      "Decompressions and instrumentations billed correctly",
      "Device billing managed with precision across every level",
      "Reduced downcoding on complex spine cases",
      "Compliance maintained on multi-level procedure billing",
  ...
  },
  {
    ...
    benefits: [
      "Arthroscopic surgeries coded with specialized precision",
      "Ligament repairs and meniscal procedures billed accurately",
      "Minimally invasive technique billing handled correctly",
      "Reduced denials on sports medicine procedure claims",
      "Consistent coding standards across every arthroscopic case",
      "Full revenue-cycle visibility on sports medicine services",
    ],
  },
  {
    Icon: Siren,
    name: "Fracture Care & Trauma",
    benefits: [
      "ORIF and complex fracture procedures billed accurately",
      "Comprehensive audits across every trauma case",
      "Reduced denials on urgent fracture care claims",
      "Coordinated billing across trauma and orthopedic teams",
      "Fast turnaround on time-sensitive fracture claims",
      "Full documentation trail on every trauma procedure",
    ],
  },
];
      ...
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="font-display text-3xl md:text-4xl tracking-tight text-ink">
            Deep expertise across orthopedic billing
          </h2>
          <p className="mt-4 text-ink/65 leading-relaxed">
            Every category of orthopedic surgery handled with the same specialized precision.
          </p>
        </motion.div>
...
const pillars: Pillar[] = [
  {
    Icon: FileSearch,
    title: "Orthopedic Surgical Auditing",
    tagline: "Uncover hidden revenue, fix systemic issues",
    benefits: [
      "Comprehensive surgical audits across every complex case",
      "Billing gaps pinpointed before they cost you revenue",
      "Hidden revenue uncovered through detailed claim analysis",
      "Systemic coding issues identified and corrected",
      "Rightful payments secured on underbilled procedures",
      "Financial health restored across your surgical practice",
  ...
  {
    Icon: Network,
    title: "Orthopedic Credentialing",
    tagline: "Faster enrollment, faster revenue",
    benefits: [
      "Expedited enrollment with hospitals, ASCs, and payers",
      "Reduced red tape across the credentialing process",
      "Faster billing ability for new providers and locations",
      "Ongoing credentialing maintenance and renewals managed",
      "Reduced delays joining new networks and facilities",
      "Full documentation trail on every credentialing application",
      "Proactive tracking of expiring credentials and contracts",
      "Coordinated support across multi-provider practices",
    ],
  },
  {
    Icon: FileCheck,
    title: "Expert Orthopedic Coding",
    tagline: "Precise CPTs, correct modifiers, maximum revenue",
    benefits: [
      "Certified orthopedic coders on every claim",
      "Precise CPT assignment across every surgical procedure",
      "Modifiers applied correctly to prevent compliance risk",
      "Maximum reimbursement on every coded procedure",
      "Reduced denials and audit exposure",
      "Ongoing coder training on the latest orthopedic coding updates",
  ...
  {
    Icon: ClipboardCheck,
    title: "Orthopedic Surgical Billing",
    tagline: "Full-cycle billing, from scrub to payment posting",
    benefits: [
      "Full billing cycle managed from claim scrub to posting",
      "Backlogs eliminated across pending surgical claims",
      "Reduced write-offs on high-value surgical procedures",
      "Every dollar captured for your surgical work",
      "Consistent claim submission across every case type",
      "Full visibility into surgical billing performance",
      "Proactive follow-up on outstanding surgical claims",
      "Custom reporting built around surgical revenue KPIs",
    ],
  },
  {
    Icon: ShieldCheck,
    title: "Prior Authorization & Insurance Verification",
    tagline: "Proactive authorization, fewer delayed surgeries",
    benefits: [
      "Automated eligibility checking ahead of every procedure",
      "Prior authorizations secured proactively for surgeries",
      "Implant and device authorizations handled in advance",
      "Reduced costly delays on scheduled procedures",
      "Coverage gaps flagged before the day of surgery",
      "Faster scheduling with authorization confirmed upfront",
      "Reduced denials tied to missing authorization",
  ...
  },
  {
    ...
    benefits: [
      ...
      "High-deductible plans explained clearly to patients",
      "Payment plans arranged for major surgical balances",
      ...
      "Freed-up staff time for clinical work",
    ],
  },
];
    ...
    <section id="services" className="bg-offwhite px-6 md:px-12 py-20 md:py-28 overflow-hidden">
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="font-display text-3xl md:text-4xl tracking-tight text-ink">
            Specialized solutions for every orthopedic revenue challenge
          </h2>
          <p className="mt-4 text-ink/65 leading-relaxed">
            Comprehensive solutions for surgical billing challenges.
          </p>
        </motion.div>
...
const whyUs: WhyItem[] = [
  { Icon: Clock, title: "24/7 RCM Support", description: "Round-the-clock support and 24-hour claim scrubbing for surgical billing." },
  { Icon: TrendingUp, title: "Faster Payer Approvals", description: "Streamlined workflows that speed up prior authorization and claims processing." },
  { Icon: Lock, title: "HIPAA-Compliant Security", description: "Military-grade encryption protecting every surgical and patient record." },
  { Icon: FileCheck, title: "100% Payment Pursuit", description: "Persistent follow-up on every claim until it's fully resolved." },
  { Icon: ShieldCheck, title: "Reduced Claim Denials", description: "Precise coding and prior authorization that prevents rejections before they happen." },
  { Icon: BarChart3, title: "Expert Orthopedic Knowledge", description: "Coders trained specifically on surgical, implant, and multi-procedure billing." },
];
      ...
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-8">
          ...
          <h2 className="font-display text-2xl md:text-3xl tracking-tight text-ink">
            Benefits of outsourcing orthopedic billing to MediShields
          </h2>
        </motion.div>
...
const testimonials: Testimonial[] = [
  {
    quote:
      "MediShields transformed our orthopedic billing. Their expertise with complex surgical coding, implant billing, and prior authorization has reduced our denials by over 40% and dramatically improved our surgical revenue.",
    name: "Muneeba Zehra",
    title: "Practice Administrator",
    company: "Premier Orthopedic Surgery Center",
  },
  {
    quote:
      "The orthopedic billing expertise of MediShields is exceptional. They handle our joint replacements, spine surgeries, sports medicine cases, and implant billing flawlessly. Our prior auth denials dropped significantly and revenue improved 30%+.",
    name: "Dr. Kristin Wolcott",
    title: "Orthopedic Surgeon",
    company: "Advanced Surgical Solutions",
  },
  {
    quote:
      "With MediShields, our orthopedic practice runs smoothly. Their knowledge of surgical coding, modifier application, bundled procedures, and payer requirements ensures we collect every dollar. They've become an essential extension of our team.",
    name: "Dr. Nisha Hirani",
    title: "Chief of Orthopedic Surgery",
    company: "Regional Orthopedic Center",
  },
];
...
const complianceItems = [
  ...
  { Icon: FileCheck, title: "Military-Grade Encryption", description: "Patient and surgical billing data encrypted in transit and at rest." },
      ...
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-xl mx-auto mb-8">
          ...
          <p className="mt-2.5 text-sm text-ink/60 leading-relaxed">
            HIPAA-compliant, secure billing infrastructure protecting every orthopedic patient and surgical record we touch.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <motion.div variants={fadeUp}>
            ...
            <h2 className="font-display text-3xl md:text-4xl tracking-tight text-ink leading-[1.1]">
              Ready to unlock peak orthopedic revenue?
            </h2>
            <p className="mt-5 text-ink/65 leading-relaxed max-w-md">
              Get started with a free consultation from our orthopedic billing experts.
            </p>
          ...
          <motion.div variants={fadeUp}>
            <LeadForm
              source="Orthopedic specialty page"
...
const relatedSpecialties = [
  ...
  { Icon: Zap, name: "Sports Medicine", href: "/specialties/orthopedic", description: "Expert billing for sports medicine and athletic procedures." },
  { Icon: Siren, name: "Emergency Medicine", href: "/specialties/emergency-medicine", description: "Expert billing for emergency and trauma care services." },
  { Icon: Syringe, name: "Anesthesiology", href: "/specialties/anesthesiology", description: "Expert billing for anesthesia services and monitoring." },
];
...
export default function OrthopedicContent({ faqs }: { faqs: Faq[] }) {
  return (
