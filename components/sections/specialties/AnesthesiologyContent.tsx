...
const valueProps = [
  "Anesthesia time units calculated precisely across every procedure",
  "Correct modifier application for pediatric and complex cases",
  "Pain management and nerve block procedures coded accurately",
  "Monitored anesthesia care billed and documented correctly",
  "Obstetric anesthesia billing with precise labor time documentation",
  "Value-based payment models supported end to end",
];
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap
        ...
        .from(".an-hero-crumb", { opacity: 0, y: 10, duration: 0.5 })
        .from(".an-hero-sub", { opacity: 0, y: 14, duration: 0.5 }, "-=0.3")
        .from(".an-hero-bullet", { opacity: 0, y: 10, duration: 0.4, stagger: 0.06 }, "-=0.2")
        .from(".an-hero-cta", { opacity: 0, y: 10, duration: 0.4, stagger: 0.08 }, "-=0.2")
        .from(".an-hero-icon", { opacity: 0, scale: 0.9, duration: 0.7 }, "-=0.6");
    }, sectionRef);
    return () => ctx.revert();
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-content mx-auto">
        <div
          aria-hidden
          className="an-hero-icon pointer-events-none absolute top-[4%] right-0 hidden xl:block w-[26vw] max-w-[380px] min-w-[260px] select-none"
        >
          <Image
            src="/icons/specialties/anesthesiology.webp"
            alt=""
            width={907}
            height={1360}
        ...
        <nav aria-label="Breadcrumb" className="an-hero-crumb mb-6 flex items-center gap-1.5 text-sm text-ink/50">
          <Link href="/specialties" className="hover:text-teal transition-colors">
            Specialties
          </Link>
          <ChevronRight className="h-3.5 w-3.5" />
          <span className="text-ink/80 font-medium">Anesthesiology</span>
        </nav>

        <h1 className="font-display text-4xl md:text-6xl tracking-tight leading-[1.05] text-ink max-w-2xl xl:max-w-xl">
          <SplitText
            tag="span"
            text={["Expert Anesthesiology", "Billing Services"]}
        ...
        <p className="an-hero-sub mt-6 max-w-2xl text-lg text-ink/70 leading-relaxed">
          Optimize revenue with precise anesthesia coding and time calculation, built around
          anesthesia time units, modifiers, and pain management billing.
        </p>

        <ul className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl">
          {valueProps.map((item) => (
            <li key={item} className="an-hero-bullet flex items-start gap-2.5 text-sm text-ink/75">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-end">
          <div>
            <motion.div variants={fadeUp}>
              <KickerLabel>Comprehensive solutions for anesthesiology billing</KickerLabel>
            </motion.div>
            <motion.h2
              variants={fadeUp}
              className="font-display text-3xl md:text-4xl tracking-tight leading-[1.1] text-ink max-w-3xl"
            >
              Expert Solutions for Anesthesia Practices
            </motion.h2>
            <motion.div variants={fadeUp} className="mt-6 max-w-3xl space-y-4 text-ink/70 text-lg leading-relaxed">
              <p>
                MediShields specializes in comprehensive anesthesiology billing services designed to
                optimize revenue and streamline operations for anesthesia practices and departments. Our
                dedicated team understands the complexities of anesthesiology coding and compliance,
                including epidural and regional block coding, missing start/stop times, and
                miscalculated time units that lead to underpayment.
              </p>
              <p>
                We provide end-to-end anesthesiology billing covering every aspect from coding and claim
                submissions to reimbursement tracking and appeals, ensuring your anesthesia time
                units are calculated correctly, documentation remains precise, and claims process
                smoothly.
              </p>
            </motion.div>
          </div>
          <motion.div variants={fadeUp}>
            <ParallaxImage
              src="/icons/specialties/overview/anesthesiology.webp"
              alt="Anesthesiology billing specialists"
            />
          </motion.div>
        </div>
      </Reveal>
...
const metrics: Metric[] = [
  { Icon: Clock, value: 28, prefix: "↓ ", suffix: " Days", label: "Days in Accounts Receivable", description: "Faster collection cycles on anesthesia claims" },
  { Icon: FileCheck, value: 96, suffix: "%", label: "First Claim Approval", description: "Clean coding on time units and modifiers" },
  { Icon: TrendingUp, value: 16, staticText: "12–16%", label: "Average Revenue Improvement", description: "More of what anesthesiology practices earn" },
  { Icon: Gauge, value: 94, suffix: "%", label: "Collection Efficiency", description: "Maximized reimbursement across every payer" },
  { Icon: CheckCircle2, value: 98, suffix: "%", label: "Error-Free Claim Rate", description: "Fewer denials on complex anesthesia cases" },
];
...
const segments: Segment[] = [
  {
    Icon: Scan,
    name: "Diagnostic Imaging Anesthesia",
    benefits: [
      "Sedation and monitoring billed accurately for MRI and CT scans",
      "Time documentation captured for every diagnostic procedure",
      "Reduced denials on imaging-related anesthesia claims",
      "Compliance maintained across payer-specific imaging guidelines",
      "Consistent coding standards across every diagnostic case",
      "Full revenue-cycle visibility on imaging anesthesia services",
    ],
  },
  {
    Icon: Scissors,
    ...
    benefits: [
      "Detailed time reporting for complex surgical procedures",
      "Precise documentation of every anesthesia time unit",
      "Correct modifier application for surgical complexity",
      "Reduced underpayment on lengthy surgical cases",
      "Coordinated billing across surgical and anesthesia teams",
      "Full audit trail on every surgical anesthesia claim",
    ],
  },
  {
    Icon: HeartPulse,
    ...
    benefits: [
      "Nerve blocks and epidural services coded with precision",
      "Value-based payment models supported for pain management",
      "Postoperative pain management billed separately and accurately",
      "Reduced denials on pain management procedure claims",
      "Compliance with innovative payment arrangement guidelines",
      "Optimized reimbursement across every pain management service",
    ],
  },
  {
    Icon: Baby,
    name: "Obstetric & Outpatient Anesthesia",
    benefits: [
      "Labor anesthesia time documented precisely for C-sections",
      "Outpatient same-day surgery anesthesia billed accurately",
      "Custom audits performed on outpatient anesthesia claims",
      "Compliance with facility-specific outpatient requirements",
      "Reduced billing errors on extended-duration procedures",
      "Maximized reimbursement across obstetric and outpatient cases",
    ],
  },
];
      ...
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="font-display text-3xl md:text-4xl tracking-tight text-ink">
            Deep expertise across anesthesiology billing
          </h2>
          <p className="mt-4 text-ink/65 leading-relaxed">
            Every category of anesthesia care handled with the same specialized precision.
          </p>
        </motion.div>
...
const pillars: Pillar[] = [
  {
    Icon: FileCheck,
    title: "Accurate Anesthesia Code Assignment",
    tagline: "Precision coding for pain management and beyond",
    benefits: [
      "Correct anesthesia codes assigned for every procedure type",
      "Careful review of procedure details before submission",
      "Coding errors eliminated before claims are ever filed",
      "Timely reimbursement for specialized treatments",
      "Consistent coding standards across every provider",
      "Full audit trail on every coded anesthesia claim",
      "Ongoing coder training on the latest anesthesia coding updates",
      "Documentation review before every claim ships",
    ],
  },
  {
    Icon: Zap,
    title: "Correct Anesthesia Modifiers",
    tagline: "Modifiers applied to reflect true case complexity",
    benefits: [
      "Pediatric anesthesia modifiers applied accurately",
      "Modifiers matched to procedure and patient complexity",
      "Reimbursement rates optimized through correct modifier use",
      "Reduced denials tied to missing or incorrect modifiers",
      "Full documentation supporting every modifier applied",
      "Consistent modifier standards across every case type",
      "Ongoing review of payer-specific modifier requirements",
      "Compliance maintained across evolving modifier guidelines",
    ],
  },
  {
    Icon: Clock,
    title: "Proper Anesthesia Time Calculation",
    tagline: "Every minute captured, nothing underbilled",
    benefits: [
      "Anesthesia time calculated accurately for every procedure",
      "Start and stop times documented precisely",
      "Reduced underbilling on lengthy anesthesia services",
      "Appropriate compensation secured for extended cases",
      "Time unit calculations verified by certified coders",
      "Consistent time-tracking standards across every case",
      "Full audit trail on every calculated time unit",
      "Reduced denials tied to time documentation gaps",
    ],
  },
  {
    Icon: Baby,
    title: "Anesthesia Bills for Obstetric Procedures",
    tagline: "Labor anesthesia billed correctly, every time",
    benefits: [
      "Precise labor anesthesia time documentation for C-sections",
      "Adherence to payer guidelines for obstetric procedures",
      "Billing errors avoided on extended-duration deliveries",
      "Maximized reimbursement for obstetric anesthesia services",
      "Coordinated billing across OB-GYN and anesthesia teams",
      "Consistent documentation standards across every delivery",
      "Reduced denials tied to obstetric-specific billing rules",
      "Full audit trail on every obstetric anesthesia claim",
    ],
  },
  {
    Icon: HeartPulse,
    title: "Postoperative Pain Management Billing",
    tagline: "Separate services, billed separately and accurately",
    benefits: [
      "Postoperative pain services billed separately from surgery",
      "Nerve blocks and continuous epidural infusions coded correctly",
      "Thoracic surgery pain management billed with precision",
      "Fair reimbursement secured for postoperative care",
      "Reduced denials on bundled versus separate billing disputes",
      "Consistent documentation standards across every pain service",
      "Full audit trail on every postoperative claim",
      "Compliance maintained with payer-specific pain billing rules",
    ],
  },
];
    ...
    <section id="services" className="bg-offwhite px-6 md:px-12 py-20 md:py-28 overflow-hidden">
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="font-display text-3xl md:text-4xl tracking-tight text-ink">
            Our suite of anesthesiology billing services
          </h2>
          <p className="mt-4 text-ink/65 leading-relaxed">
            Comprehensive solutions for anesthesia billing challenges.
          </p>
        </motion.div>
...
const whyUs: WhyItem[] = [
  { Icon: ShieldCheck, title: "90% Fewer Claim Denials", description: "Precise coding and modifier management that prevents rejections before they happen." },
  { Icon: TrendingUp, title: "35% Increase in Revenue Collections", description: "Full-cycle billing designed to capture every anesthesia time unit earned." },
  { Icon: Users, title: "80% Less Administrative Workload", description: "Free your team from billing complexity so they can focus on patient care." },
  { Icon: FileCheck, title: "100% Guideline Compliance", description: "Billing kept aligned with evolving anesthesia billing regulations." },
  { Icon: Clock, title: "50% Faster Claims Submission", description: "Streamlined workflows that keep cash flow predictable across every case." },
  { Icon: BarChart3, title: "Expert Anesthesiology Knowledge", description: "Coders trained specifically on anesthesia time units and modifier billing." },
];
      ...
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-8">
          ...
          <h2 className="font-display text-2xl md:text-3xl tracking-tight text-ink">
            Benefits of outsourcing anesthesiology billing to MediShields
          </h2>
        </motion.div>
...
const testimonials: Testimonial[] = [
  {
    quote:
      "MediShields transformed our anesthesiology billing. Their expertise with anesthesia time calculations and modifier management has reduced our denials by over 40% and dramatically improved our revenue.",
    name: "Muneeba Zehra",
    title: "Business Manager",
    company: "Premier Anesthesia Group",
  },
  {
    quote:
      "The anesthesiology billing expertise of MediShields is exceptional. They handle our pain management coding, surgical anesthesia time documentation, and complex cases flawlessly. Our administrative burden decreased significantly.",
    name: "Dr. Kristin Wolcott",
    title: "Anesthesiologist",
    company: "Advanced Pain Management",
  },
  {
    quote:
      "With MediShields, our anesthesiology practice runs smoothly. Their knowledge of anesthesia billing guidelines, modifier applications, and time unit calculations ensures we collect every dollar. They've become an extension of our team.",
    name: "Dr. Nisha Hirani",
    title: "Chief Anesthesiologist",
    company: "Regional Anesthesia Services",
  },
];
    ...
    <section className="bg-offwhite px-6 md:px-12 py-16 md:py-20">
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h2 className="font-display text-3xl md:text-4xl tracking-tight text-ink">
            What anesthesiology practices say
          </h2>
        </motion.div>
...
const complianceItems = [
  ...
  { Icon: FileCheck, title: "Advanced Encryption", description: "Patient anesthesia billing data encrypted in transit and at rest." },
      ...
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-xl mx-auto mb-8">
          ...
          <p className="mt-2.5 text-sm text-ink/60 leading-relaxed">
            HIPAA-compliant, secure billing infrastructure protecting every anesthesiology patient record we touch.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <motion.div variants={fadeUp}>
            ...
            <h2 className="font-display text-3xl md:text-4xl tracking-tight text-ink leading-[1.1]">
              Ready to transform your anesthesiology billing?
            </h2>
            <p className="mt-5 text-ink/65 leading-relaxed max-w-md">
              Get started with a free consultation from our anesthesiology billing experts.
            </p>
          ...
          <motion.div variants={fadeUp}>
            <LeadForm
              source="Anesthesiology specialty page"
...
const relatedSpecialties = [
  ...
  { Icon: HeartPulse, name: "Pain Management", href: "/specialties/anesthesiology", description: "Specialized billing for pain management procedures." },
  { Icon: Activity, name: "Radiology", href: "/specialties/radiology", description: "Expert billing for imaging and diagnostic services." },
];
...
export default function AnesthesiologyContent({ faqs }: { faqs: Faq[] }) {
  return (
