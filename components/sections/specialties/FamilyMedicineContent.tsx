...
const valueProps = [
  "Preventive care and annual physicals billed without frequency-cap denials",
  "Chronic disease management coded accurately for diabetes and hypertension",
  "Acute and urgent visits billed with correct E/M complexity levels",
  "Coordination of benefits handled correctly for dual-coverage patients",
  "High patient volume processed without sacrificing claim accuracy",
  "Seamless integration with Epic, Cerner, Athenahealth, and more",
];
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap
        ...
        .from(".fam-hero-crumb", { opacity: 0, y: 10, duration: 0.5 })
        .from(".fam-hero-sub", { opacity: 0, y: 14, duration: 0.5 }, "-=0.3")
        .from(".fam-hero-bullet", { opacity: 0, y: 10, duration: 0.4, stagger: 0.06 }, "-=0.2")
        .from(".fam-hero-cta", { opacity: 0, y: 10, duration: 0.4, stagger: 0.08 }, "-=0.2")
        .from(".fam-hero-icon", { opacity: 0, scale: 0.9, duration: 0.7 }, "-=0.6");
    }, sectionRef);
    return () => ctx.revert();
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-content mx-auto">
        <div
          aria-hidden
          className="fam-hero-icon pointer-events-none absolute top-[2%] right-0 hidden xl:block w-[30vw] max-w-[470px] min-w-[300px] select-none"
        >
          <Image
            src="/icons/specialties/family-medicine.webp"
            alt=""
            width={1254}
            height={1254}
            className="w-full h-auto rounded-3xl"
            sizes="(min-width: 1280px) 470px, 0px"
            priority
          />
        </div>
        <nav aria-label="Breadcrumb" className="fam-hero-crumb mb-6 flex items-center gap-1.5 text-sm text-ink/50">
          <Link href="/specialties" className="hover:text-teal transition-colors">
            Specialties
          </Link>
          <ChevronRight className="h-3.5 w-3.5" />
          <span className="text-ink/80 font-medium">Family Medicine</span>
        </nav>

        <h1 className="font-display text-4xl md:text-6xl tracking-tight leading-[1.05] text-ink max-w-2xl xl:max-w-xl">
          <SplitText
            tag="span"
            text={["Expert Family Medicine", "Billing Services"]}
        ...
        <p className="fam-hero-sub mt-6 max-w-2xl text-lg text-ink/70 leading-relaxed">
          Simplify billing, strengthen care. Built around high patient volumes, preventive
          care, chronic disease management, and diverse patient populations.
        </p>

        <ul className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl">
          {valueProps.map((item) => (
            <li key={item} className="fam-hero-bullet flex items-start gap-2.5 text-sm text-ink/75">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-end">
          <div>
            <motion.div variants={fadeUp}>
              <KickerLabel>Major family medicine billing challenges we solve</KickerLabel>
            </motion.div>
            <motion.h2
              variants={fadeUp}
              className="font-display text-3xl md:text-4xl tracking-tight leading-[1.1] text-ink max-w-3xl"
            >
              Expert Solutions for Primary Care Practices
            </motion.h2>
            <motion.div variants={fadeUp} className="mt-6 max-w-3xl space-y-4 text-ink/70 text-lg leading-relaxed">
              <p>
                From routine preventive visits to complex chronic disease management, family medicine
                handles the widest range of visit types of any specialty, and that range brings
                its own denial risk: pre-existing condition rejections, preventive service frequency
                caps, coordination of benefits errors, and bundled service confusion between E/M visits
                and procedures.
              </p>
              <p>
                MediShields specializes in family medicine billing, handling the full spectrum of
                primary care services with the same accuracy at any patient volume, so your
                practice captures every dollar earned while staying focused on delivering exceptional
                primary care.
              </p>
            </motion.div>
          </div>
          <motion.div variants={fadeUp}>
            <ParallaxImage
              src="/icons/specialties/overview/family-medicine.webp"
              alt="Family Medicine billing specialists"
            />
          </motion.div>
        </div>
      </Reveal>
...
const metrics: Metric[] = [
  { Icon: Clock, value: 30, prefix: "↓ ", suffix: " Days", label: "Days in Accounts Receivable", description: "Faster collection cycles at any patient volume" },
  { Icon: FileCheck, value: 96, suffix: "%", label: "First Claim Approval", description: "Clean coding across every visit type" },
  { Icon: TrendingUp, value: 16, staticText: "12–16%", label: "Average Revenue Improvement", description: "More of what family medicine practices earn" },
  { Icon: Gauge, value: 94, suffix: "%", label: "Collection Efficiency", description: "Maximized reimbursement across every payer" },
  { Icon: CheckCircle2, value: 98, suffix: "%", label: "Error-Free Claim Rate", description: "Fewer denials across high-volume claim batches" },
];
...
const segments: Segment[] = [
  {
    ...
    benefits: [
      "Annual physicals and wellness visits coded accurately",
      "Preventive screenings billed without frequency-cap denials",
      "Preventive procedures documented and coded correctly",
      "Reduced denials on routine preventive claims",
      "Consistent coding standards across every wellness visit",
  ...
  },
  {
    ...
    benefits: [
      "Diabetes, hypertension, and COPD billed with precision",
      "Follow-up visit coding aligned with disease management guidelines",
      "Reduced denials on long-term condition management claims",
      "Consistent coding standards across every chronic condition",
      "Full revenue-cycle visibility on chronic care billing",
      "Coordinated billing across referred specialists",
    ],
  },
  {
    Icon: Zap,
    ...
    benefits: [
      "Urgent and sick visits coded with accurate E/M complexity",
      "Problem-focused visits billed correctly alongside wellness care",
      "Reduced denials on same-day acute care claims",
      "Consistent documentation standards across every acute visit",
      "Fast turnaround on high-volume acute care claims",
      "Full audit trail on every acute visit billed",
    ],
  },
  {
    Icon: Syringe,
    ...
    benefits: [
      "Vaccinations billed accurately alongside office visits",
      "Minor in-office procedures coded correctly",
      "Diagnostic procedures billed without bundling errors",
      "Reduced denials on combined visit-and-procedure claims",
      "Consistent coding standards across every procedure type",
      "Full documentation trail on every procedural claim",
    ],
  },
];
      ...
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="font-display text-3xl md:text-4xl tracking-tight text-ink">
            Deep expertise across family medicine billing
          </h2>
          <p className="mt-4 text-ink/65 leading-relaxed">
            Every visit type handled with the same specialized precision, at any patient volume.
          </p>
        </motion.div>
...
const pillars: Pillar[] = [
  {
    Icon: FileSearch,
    title: "Family Medicine Auditing",
    tagline: "Uncover hidden revenue, fix systemic issues",
    benefits: [
      "Deep-dive auditing across every claim category",
      "Billing gaps uncovered before they cost you revenue",
      "Missed revenue opportunities identified through analysis",
      "Systemic coding issues corrected at the source",
      "Accurate payments secured across every claim type",
      "Financial control restored across your practice",
  ...
  {
    Icon: Network,
    title: "Family Medicine Credentialing",
    tagline: "Faster enrollment, faster patient access",
    benefits: [
      "Fast-tracked enrollment with top payers",
      "Reduced red tape across the credentialing process",
      "Reduced wait times for new provider enrollment",
      "New patient access and revenue streams opened faster",
  ...
  {
    Icon: FileCheck,
    title: "Family Medicine Coding",
    tagline: "Accurate ICD-10/CPT use, every claim",
    benefits: [
      "Certified coders on every family medicine claim",
      "Accurate ICD-10 and CPT use across every visit type",
      "Compliance errors prevented before they trigger audits",
      "Every claim aligned with payer-specific rules",
      "Faster payment through accurate first-pass coding",
      "Ongoing coder training on the latest coding updates",
  ...
  {
    Icon: ClipboardCheck,
    title: "Family Medicine Billing Management",
    tagline: "Full-cycle billing, from submission to posting",
    benefits: [
      "Entire billing process managed from submission to posting",
      "Backlogs eliminated across pending claims",
      "Reduced write-offs on eligible services",
      "Reimbursement ensured for every eligible claim",
      "Consistent claim submission across every visit type",
      "Full visibility into billing performance",
  ...
  {
    Icon: ShieldCheck,
    title: "Family Medicine Insurance Verification",
    tagline: "Real-time verification, fewer surprise denials",
    benefits: [
      "Automated insurance verification with real-time tools",
      "Last-minute eligibility surprises eliminated",
      "Increased claim acceptance through upfront verification",
      "Coverage gaps flagged before the day of the visit",
      "Reduced denials tied to eligibility issues",
  ...
  },
  {
    ...
    benefits: [
      ...
      "Insurance benefits explained clearly to patients",
      "Payment options arranged to ease patient concerns",
      "Improved collection rates without burdening staff",
    ...
    <section id="services" className="bg-offwhite px-6 md:px-12 py-20 md:py-28 overflow-hidden">
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="font-display text-3xl md:text-4xl tracking-tight text-ink">
            Our suite of family medicine billing services
          </h2>
          <p className="mt-4 text-ink/65 leading-relaxed">
            Comprehensive solutions for primary care practice challenges.
          </p>
        </motion.div>
...
const whyUs: WhyItem[] = [
  { Icon: Clock, title: "24/7 RCM Support", description: "Round-the-clock support and 24-hour claim processing for primary care." },
  { Icon: TrendingUp, title: "Faster Claim Approvals", description: "Streamlined workflows that speed up high-volume claims processing." },
  { Icon: ShieldCheck, title: "40% Denial Reduction", description: "Precise coding and verification that prevents rejections before they happen." },
  { Icon: Lock, title: "HIPAA-Compliant Security", description: "Advanced encryption protecting every patient record we touch." },
  { Icon: FileCheck, title: "24-Hour Claim Processing", description: "Consistent turnaround regardless of patient volume." },
  { Icon: BarChart3, title: "Expert Family Medicine Knowledge", description: "Coders trained specifically on primary care's full range of visit types." },
];
      ...
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-8">
          ...
          <h2 className="font-display text-2xl md:text-3xl tracking-tight text-ink">
            Benefits of outsourcing family medicine billing to MediShields
          </h2>
        </motion.div>
...
const testimonials: Testimonial[] = [
  {
    quote:
      "MediShields transformed our family medicine billing. Their expertise with high patient volumes and complex coding has reduced our denials by over 40% and dramatically improved our practice revenue.",
    name: "Muneeba Zehra",
    title: "Practice Manager",
    company: "Premier Family Health Group",
  },
  {
    quote:
      "The family medicine billing expertise of MediShields is exceptional. They handle our preventive care, chronic disease management, acute visits, and procedural services flawlessly. Our administrative burden decreased significantly.",
    name: "Dr. Kristin Wolcott",
    title: "Family Medicine Physician",
    company: "Advanced Primary Care Solutions",
  },
  {
    quote:
      "With MediShields, our family medicine practice runs smoothly. Their knowledge of primary care coding, insurance requirements, and high-volume processing ensures we collect every dollar. They've become essential to our team.",
    name: "Dr. Nisha Hirani",
    title: "Practice Owner",
    company: "Regional Family Health Center",
  },
];
    ...
    <section className="bg-offwhite px-6 md:px-12 py-16 md:py-20">
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h2 className="font-display text-3xl md:text-4xl tracking-tight text-ink">
            What family medicine practices say
          </h2>
        </motion.div>
    ...
    <section className="bg-white px-6 md:px-12 py-20 md:py-28 border-t border-ink/10">
      <Reveal className="max-w-content mx-auto max-w-3xl">
        <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="font-display text-3xl md:text-4xl tracking-tight text-ink">
            Family medicine billing, answered
          </h2>
        </motion.div>
        <motion.div variants={fadeUp}>
      ...
      <Reveal className="max-w-content mx-auto">
        <motion.div variants={fadeUp} className="text-center max-w-xl mx-auto mb-8">
          ...
          <p className="mt-2.5 text-sm text-ink/60 leading-relaxed">
            HIPAA-compliant, secure billing infrastructure protecting every family medicine patient record we touch.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <motion.div variants={fadeUp}>
            ...
            <h2 className="font-display text-3xl md:text-4xl tracking-tight text-ink leading-[1.1]">
              Ready to simplify your family medicine billing?
            </h2>
            <p className="mt-5 text-ink/65 leading-relaxed max-w-md">
              Get started with a free consultation from our family medicine billing experts.
            </p>
          ...
          <motion.div variants={fadeUp}>
            <LeadForm
              source="Family Medicine specialty page"
...
const relatedSpecialties = [
  ...
  { Icon: Baby, name: "Pediatrics", href: "/specialties/pediatrics", description: "Specialized billing for pediatric and child healthcare." },
  { Icon: Scissors, name: "Surgery", href: "/specialties/surgery", description: "Specialized billing for surgical procedures." },
  { Icon: Activity, name: "Cardiology", href: "/specialties/cardiology", description: "Expert billing for cardiovascular services." },
];
...
export default function FamilyMedicineContent({ faqs }: { faqs: Faq[] }) {
  return (
